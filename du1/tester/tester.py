...
os.system('cp results1.html logs/results-`date -Iseconds`.html')

#if len(sys.argv) == 1:
    #os.system('scp results1.html mino@ksp.sk:public_html/os/du1/')
    #os.system('scp results1.html mino@ksp.sk:public_html/os/du1/results-`date -Iseconds`.html')
